...
def ingest_workload_prompt(
    ...
    if request.auto_optimize or dispatch:
        ...
        # Logic omitted for brevity, identical to original main.py
    ...
    return PromptIngestionResponse(prompt=request.prompt, parsed_spec=parsed_spec, optimization_result=opt_result, gemini_explanation=gemini_exp, workflow_execution=wf_result)